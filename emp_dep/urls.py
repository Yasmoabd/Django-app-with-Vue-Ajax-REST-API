...
from . import views
from emp_dep.api import employees_api, departments_api, employee_api, department_api
...
urlpatterns = [
    ...
    path('api/department/<int:department_id>/', department_api, name="department api"),
]